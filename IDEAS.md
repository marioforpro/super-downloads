...
- 2026-05-31 | One-click in-app auto-update UX — "Update" button → app relaunches itself (Claude Code / Codex desktop style) [size: M] [confidence: 4] [presence: high] [shipped→v1.1.1] [id: 0029]
...
- 2026-05-31 | Runtime yt-dlp self-update — refresh the extractor without an app release [size: M] [confidence: 3] [presence: high] [implemented→Unreleased 2026-06-16] [id: 0030]
...
- 2026-07-17 | Competitor feature reference — oop7/YTSage [competitor-reference]
